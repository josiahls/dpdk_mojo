...
alias rte_hash_create = fn (UnsafePointer[rte_hash_parameters]) -> UnsafePointer[rte_hash]
...
alias rte_hash_count = fn (UnsafePointer[rte_hash]) -> ffi.c_int
alias rte_hash_max_key_id = fn (UnsafePointer[rte_hash]) -> ffi.c_int
alias rte_hash_add_key_data = fn (UnsafePointer[rte_hash], OpaquePointer, OpaquePointer) -> ffi.c_int
alias rte_hash_add_key_with_hash_data = fn (UnsafePointer[rte_hash], OpaquePointer, hash_sig_t, OpaquePointer) -> ffi.c_int
alias rte_hash_add_key = fn (UnsafePointer[rte_hash], OpaquePointer) -> ffi.c_int
alias rte_hash_add_key_with_hash = fn (UnsafePointer[rte_hash], OpaquePointer, hash_sig_t) -> ffi.c_int
alias rte_hash_del_key = fn (UnsafePointer[rte_hash], OpaquePointer) -> ffi.c_int
alias rte_hash_del_key_with_hash = fn (UnsafePointer[rte_hash], OpaquePointer, hash_sig_t) -> ffi.c_int
alias rte_hash_get_key_with_position = fn (UnsafePointer[rte_hash], ffi.c_int, UnsafePointer[OpaquePointer]) -> ffi.c_int
alias rte_hash_free_key_with_position = fn (UnsafePointer[rte_hash], ffi.c_int) -> ffi.c_int
alias rte_hash_lookup_data = fn (UnsafePointer[rte_hash], OpaquePointer, UnsafePointer[OpaquePointer]) -> ffi.c_int
alias rte_hash_lookup_with_hash_data = fn (UnsafePointer[rte_hash], OpaquePointer, hash_sig_t, UnsafePointer[OpaquePointer]) -> ffi.c_int
alias rte_hash_lookup = fn (UnsafePointer[rte_hash], OpaquePointer) -> ffi.c_int
alias rte_hash_lookup_with_hash = fn (UnsafePointer[rte_hash], OpaquePointer, hash_sig_t) -> ffi.c_int
alias rte_hash_hash = fn (UnsafePointer[rte_hash], OpaquePointer) -> hash_sig_t
alias rte_hash_lookup_bulk_data = fn (UnsafePointer[rte_hash], UnsafePointer[OpaquePointer], ffi.c_int, UnsafePointer[ffi.c_ulong_long], UnsafePointer[OpaquePointer]) -> ffi.c_int
alias rte_hash_lookup_with_hash_bulk = fn (UnsafePointer[rte_hash], UnsafePointer[OpaquePointer], UnsafePointer[hash_sig_t], ffi.c_int, UnsafePointer[ffi.c_int]) -> ffi.c_int
alias rte_hash_lookup_with_hash_bulk_data = fn (UnsafePointer[rte_hash], UnsafePointer[OpaquePointer], UnsafePointer[hash_sig_t], ffi.c_int, UnsafePointer[ffi.c_ulong_long], UnsafePointer[OpaquePointer]) -> ffi.c_int
alias rte_hash_lookup_bulk = fn (UnsafePointer[rte_hash], UnsafePointer[OpaquePointer], ffi.c_int, UnsafePointer[ffi.c_int]) -> ffi.c_int
alias rte_hash_iterate = fn (UnsafePointer[rte_hash], UnsafePointer[OpaquePointer], UnsafePointer[OpaquePointer], UnsafePointer[ffi.c_int]) -> ffi.c_int
alias rte_hash_rcu_qsbr_add = fn (UnsafePointer[rte_hash], UnsafePointer[rte_hash_rcu_config]) -> ffi.c_int
alias rte_hash_rcu_qsbr_dq_reclaim = fn (UnsafePointer[rte_hash], UnsafePointer[ffi.c_int], UnsafePointer[ffi.c_int], UnsafePointer[ffi.c_int]) -> ffi.c_int
