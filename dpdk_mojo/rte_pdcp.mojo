...
alias rte_pdcp_entity_release = fn (UnsafePointer[rte_pdcp_entity], UnsafePointer[UnsafePointer[rte_mbuf]]) -> ffi.c_int
alias rte_pdcp_entity_suspend = fn (UnsafePointer[rte_pdcp_entity], UnsafePointer[UnsafePointer[rte_mbuf]]) -> ffi.c_int
