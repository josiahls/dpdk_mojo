...
struct rte_efd_table(Copyable & Movable):
	pass
alias rte_efd_create = fn (UnsafePointer[Int8], ffi.c_int, ffi.c_int, ffi.c_ulong_long, UInt8) -> UnsafePointer[rte_efd_table]
...
alias rte_efd_update = fn (UnsafePointer[rte_efd_table], ffi.c_int, OpaquePointer, efd_value_t) -> ffi.c_int
alias rte_efd_delete = fn (UnsafePointer[rte_efd_table], ffi.c_int, OpaquePointer, UnsafePointer[efd_value_t]) -> ffi.c_int
alias rte_efd_lookup = fn (UnsafePointer[rte_efd_table], ffi.c_int, OpaquePointer) -> efd_value_t
alias rte_efd_lookup_bulk = fn (UnsafePointer[rte_efd_table], ffi.c_int, ffi.c_int, UnsafePointer[OpaquePointer], UnsafePointer[efd_value_t]) -> NoneType
