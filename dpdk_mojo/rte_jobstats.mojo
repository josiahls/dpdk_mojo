...
alias rte_jobstats_context_init = fn (UnsafePointer[rte_jobstats_context]) -> ffi.c_int
...
alias rte_jobstats_init = fn (UnsafePointer[rte_jobstats], UnsafePointer[Int8], ffi.c_ulong_long, ffi.c_ulong_long, ffi.c_ulong_long, ffi.c_long_long) -> ffi.c_int
alias rte_jobstats_set_target = fn (UnsafePointer[rte_jobstats], ffi.c_long_long) -> NoneType
alias rte_jobstats_start = fn (UnsafePointer[rte_jobstats_context], UnsafePointer[rte_jobstats]) -> ffi.c_int
alias rte_jobstats_abort = fn (UnsafePointer[rte_jobstats]) -> ffi.c_int
alias rte_jobstats_finish = fn (UnsafePointer[rte_jobstats], ffi.c_long_long) -> ffi.c_int
