...
alias __rte_jhash_2hashes = fn (OpaquePointer, ffi.c_int, UnsafePointer[ffi.c_int], UnsafePointer[ffi.c_int], ffi.c_int) -> NoneType
alias rte_jhash_2hashes = fn (OpaquePointer, ffi.c_int, UnsafePointer[ffi.c_int], UnsafePointer[ffi.c_int]) -> NoneType
alias rte_jhash_32b_2hashes = fn (UnsafePointer[ffi.c_int], ffi.c_int, UnsafePointer[ffi.c_int], UnsafePointer[ffi.c_int]) -> NoneType
alias rte_jhash = fn (OpaquePointer, ffi.c_int, ffi.c_int) -> ffi.c_int
alias rte_jhash_32b = fn (UnsafePointer[ffi.c_int], ffi.c_int, ffi.c_int) -> ffi.c_int
alias __rte_jhash_3words = fn (ffi.c_int, ffi.c_int, ffi.c_int, ffi.c_int) -> ffi.c_int
alias rte_jhash_3words = fn (ffi.c_int, ffi.c_int, ffi.c_int, ffi.c_int) -> ffi.c_int
alias rte_jhash_2words = fn (ffi.c_int, ffi.c_int, ffi.c_int) -> ffi.c_int
alias rte_jhash_1word = fn (ffi.c_int, ffi.c_int) -> ffi.c_int
...
alias rte_member_lookup = fn (UnsafePointer[rte_member_setsum], OpaquePointer, UnsafePointer[member_set_t]) -> ffi.c_int
alias rte_member_lookup_bulk = fn (UnsafePointer[rte_member_setsum], UnsafePointer[OpaquePointer], ffi.c_int, UnsafePointer[member_set_t]) -> ffi.c_int
alias rte_member_lookup_multi = fn (UnsafePointer[rte_member_setsum], OpaquePointer, ffi.c_int, UnsafePointer[member_set_t]) -> ffi.c_int
alias rte_member_lookup_multi_bulk = fn (UnsafePointer[rte_member_setsum], UnsafePointer[OpaquePointer], ffi.c_int, ffi.c_int, UnsafePointer[ffi.c_int], UnsafePointer[member_set_t]) -> ffi.c_int
alias rte_member_add = fn (UnsafePointer[rte_member_setsum], OpaquePointer, member_set_t) -> ffi.c_int
alias rte_member_add_byte_count = fn (UnsafePointer[rte_member_setsum], OpaquePointer, ffi.c_int) -> ffi.c_int
alias rte_member_query_count = fn (UnsafePointer[rte_member_setsum], OpaquePointer, UnsafePointer[ffi.c_ulong_long]) -> ffi.c_int
alias rte_member_report_heavyhitter = fn (UnsafePointer[rte_member_setsum], UnsafePointer[OpaquePointer], UnsafePointer[ffi.c_ulong_long]) -> ffi.c_int
alias rte_member_reset = fn (UnsafePointer[rte_member_setsum]) -> NoneType
alias rte_member_delete = fn (UnsafePointer[rte_member_setsum], OpaquePointer, member_set_t) -> ffi.c_int
