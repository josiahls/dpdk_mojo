...
alias __rte_stack_std_push = fn (UnsafePointer[rte_stack], UnsafePointer[OpaquePointer, mut=False], UInt32) -> UInt32
...
alias __rte_stack_lf_push = fn (UnsafePointer[rte_stack], UnsafePointer[OpaquePointer, mut=False], UInt32) -> UInt32
...
alias rte_stack_push = fn (UnsafePointer[rte_stack], UnsafePointer[OpaquePointer, mut=False], UInt32) -> UInt32
