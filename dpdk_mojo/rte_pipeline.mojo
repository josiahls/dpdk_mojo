...
alias rte_pipeline_table_create = fn (UnsafePointer[rte_pipeline], UnsafePointer[rte_pipeline_table_params], UnsafePointer[UInt32]) -> Int32
alias rte_pipeline_table_default_entry_add = fn (UnsafePointer[rte_pipeline], UInt32, UnsafePointer[rte_pipeline_table_entry], UnsafePointer[UnsafePointer[rte_pipeline_table_entry]]) -> Int32
alias rte_pipeline_table_default_entry_delete = fn (UnsafePointer[rte_pipeline], UInt32, UnsafePointer[rte_pipeline_table_entry]) -> Int32
alias rte_pipeline_table_entry_add = fn (UnsafePointer[rte_pipeline], UInt32, OpaquePointer, UnsafePointer[rte_pipeline_table_entry], UnsafePointer[Int32], UnsafePointer[UnsafePointer[rte_pipeline_table_entry]]) -> Int32
alias rte_pipeline_table_entry_delete = fn (UnsafePointer[rte_pipeline], UInt32, OpaquePointer, UnsafePointer[Int32], UnsafePointer[rte_pipeline_table_entry]) -> Int32
alias rte_pipeline_table_entry_add_bulk = fn (UnsafePointer[rte_pipeline], UInt32, UnsafePointer[OpaquePointer], UnsafePointer[UnsafePointer[rte_pipeline_table_entry]], UInt32, UnsafePointer[Int32], UnsafePointer[UnsafePointer[rte_pipeline_table_entry]]) -> Int32
alias rte_pipeline_table_entry_delete_bulk = fn (UnsafePointer[rte_pipeline], UInt32, UnsafePointer[OpaquePointer], UInt32, UnsafePointer[Int32], UnsafePointer[UnsafePointer[rte_pipeline_table_entry]]) -> Int32
alias rte_pipeline_table_stats_read = fn (UnsafePointer[rte_pipeline], UInt32, UnsafePointer[rte_pipeline_table_stats], Int32) -> Int32
...
alias rte_pipeline_port_in_create = fn (UnsafePointer[rte_pipeline], UnsafePointer[rte_pipeline_port_in_params], UnsafePointer[UInt32]) -> Int32
alias rte_pipeline_port_in_connect_to_table = fn (UnsafePointer[rte_pipeline], UInt32, UInt32) -> Int32
alias rte_pipeline_port_in_enable = fn (UnsafePointer[rte_pipeline], UInt32) -> Int32
alias rte_pipeline_port_in_disable = fn (UnsafePointer[rte_pipeline], UInt32) -> Int32
alias rte_pipeline_port_in_stats_read = fn (UnsafePointer[rte_pipeline], UInt32, UnsafePointer[rte_pipeline_port_in_stats], Int32) -> Int32
...
alias rte_pipeline_port_out_create = fn (UnsafePointer[rte_pipeline], UnsafePointer[rte_pipeline_port_out_params], UnsafePointer[UInt32]) -> Int32
alias rte_pipeline_port_out_stats_read = fn (UnsafePointer[rte_pipeline], UInt32, UnsafePointer[rte_pipeline_port_out_stats], Int32) -> Int32
alias rte_pipeline_port_out_packet_insert = fn (UnsafePointer[rte_pipeline], UInt32, UnsafePointer[rte_mbuf]) -> Int32
alias rte_pipeline_ah_packet_hijack = fn (UnsafePointer[rte_pipeline], ffi.c_ulong) -> Int32
alias rte_pipeline_ah_packet_drop = fn (UnsafePointer[rte_pipeline], ffi.c_ulong) -> Int32
