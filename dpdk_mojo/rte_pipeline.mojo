...
alias rte_pipeline_free = fn (UnsafePointer[rte_pipeline]) -> ffi.c_int
alias rte_pipeline_check = fn (UnsafePointer[rte_pipeline]) -> ffi.c_int
alias rte_pipeline_run = fn (UnsafePointer[rte_pipeline]) -> ffi.c_int
alias rte_pipeline_flush = fn (UnsafePointer[rte_pipeline]) -> ffi.c_int
...
alias rte_pipeline_table_create = fn (UnsafePointer[rte_pipeline], UnsafePointer[rte_pipeline_table_params], UnsafePointer[ffi.c_int]) -> ffi.c_int
alias rte_pipeline_table_default_entry_add = fn (UnsafePointer[rte_pipeline], ffi.c_int, UnsafePointer[rte_pipeline_table_entry], UnsafePointer[UnsafePointer[rte_pipeline_table_entry]]) -> ffi.c_int
alias rte_pipeline_table_default_entry_delete = fn (UnsafePointer[rte_pipeline], ffi.c_int, UnsafePointer[rte_pipeline_table_entry]) -> ffi.c_int
alias rte_pipeline_table_entry_add = fn (UnsafePointer[rte_pipeline], ffi.c_int, OpaquePointer, UnsafePointer[rte_pipeline_table_entry], UnsafePointer[ffi.c_int], UnsafePointer[UnsafePointer[rte_pipeline_table_entry]]) -> ffi.c_int
alias rte_pipeline_table_entry_delete = fn (UnsafePointer[rte_pipeline], ffi.c_int, OpaquePointer, UnsafePointer[ffi.c_int], UnsafePointer[rte_pipeline_table_entry]) -> ffi.c_int
alias rte_pipeline_table_entry_add_bulk = fn (UnsafePointer[rte_pipeline], ffi.c_int, UnsafePointer[OpaquePointer], UnsafePointer[UnsafePointer[rte_pipeline_table_entry]], ffi.c_int, UnsafePointer[ffi.c_int], UnsafePointer[UnsafePointer[rte_pipeline_table_entry]]) -> ffi.c_int
alias rte_pipeline_table_entry_delete_bulk = fn (UnsafePointer[rte_pipeline], ffi.c_int, UnsafePointer[OpaquePointer], ffi.c_int, UnsafePointer[ffi.c_int], UnsafePointer[UnsafePointer[rte_pipeline_table_entry]]) -> ffi.c_int
alias rte_pipeline_table_stats_read = fn (UnsafePointer[rte_pipeline], ffi.c_int, UnsafePointer[rte_pipeline_table_stats], ffi.c_int) -> ffi.c_int
...
alias rte_pipeline_port_in_create = fn (UnsafePointer[rte_pipeline], UnsafePointer[rte_pipeline_port_in_params], UnsafePointer[ffi.c_int]) -> ffi.c_int
alias rte_pipeline_port_in_connect_to_table = fn (UnsafePointer[rte_pipeline], ffi.c_int, ffi.c_int) -> ffi.c_int
alias rte_pipeline_port_in_enable = fn (UnsafePointer[rte_pipeline], ffi.c_int) -> ffi.c_int
alias rte_pipeline_port_in_disable = fn (UnsafePointer[rte_pipeline], ffi.c_int) -> ffi.c_int
alias rte_pipeline_port_in_stats_read = fn (UnsafePointer[rte_pipeline], ffi.c_int, UnsafePointer[rte_pipeline_port_in_stats], ffi.c_int) -> ffi.c_int
...
alias rte_pipeline_port_out_create = fn (UnsafePointer[rte_pipeline], UnsafePointer[rte_pipeline_port_out_params], UnsafePointer[ffi.c_int]) -> ffi.c_int
alias rte_pipeline_port_out_stats_read = fn (UnsafePointer[rte_pipeline], ffi.c_int, UnsafePointer[rte_pipeline_port_out_stats], ffi.c_int) -> ffi.c_int
alias rte_pipeline_port_out_packet_insert = fn (UnsafePointer[rte_pipeline], ffi.c_int, UnsafePointer[rte_mbuf]) -> ffi.c_int
alias rte_pipeline_ah_packet_hijack = fn (UnsafePointer[rte_pipeline], ffi.c_ulong_long) -> ffi.c_int
alias rte_pipeline_ah_packet_drop = fn (UnsafePointer[rte_pipeline], ffi.c_ulong_long) -> ffi.c_int
