...
alias rte_dma_dev_max = fn (size_t) -> ffi.c_int
alias rte_dma_get_dev_id_by_name = fn (UnsafePointer[Int8]) -> ffi.c_int
...
alias rte_dma_info_get = fn (Int16, UnsafePointer[rte_dma_info]) -> ffi.c_int
...
alias rte_dma_configure = fn (Int16, UnsafePointer[rte_dma_conf]) -> ffi.c_int
alias rte_dma_start = fn (Int16) -> ffi.c_int
alias rte_dma_stop = fn (Int16) -> ffi.c_int
alias rte_dma_close = fn (Int16) -> ffi.c_int
...
# # {.unparsed}#  System Bus#     |     ----------PCIe module----------#     |     Bus#     |     Interface#     |     -----        ------------------#     |     |   |        | PCIe Core0     |#     |     |   |        |                |        -----------#     |     |   |        |   PF-0 -- VF-0 |        | Host A  |#     |     |   |--------|        |- VF-1 |--------| Root    |#     |     |   |        |   PF-1         |        | Complex |#     |     |   |        |   PF-2         |        -----------#     |     |   |        ------------------#     |     |   |#     |     |   |        ------------------#     |     |   |        | PCIe Core1     |#     |     |   |        |                |        -----------#     |     |   |        |   PF-0 -- VF-0 |        | Host B  |#     |-----|   |--------|   PF-1 -- VF-0 |--------| Root    |#     |     |   |        |        |- VF-1 |        | Complex |#     |     |   |        |   PF-2         |        -----------#     |     |   |        ------------------#     |     |   |#     |     |   |        ------------------#     |     |DMA|        |                |        ------#     |     |   |        |                |--------| EP |#     |     |   |--------| PCIe Core2     |        ------#     |     |   |        |                |        ------#     |     |   |        |                |--------| EP |#     |     |   |        |                |        ------#     |     -----        ------------------# # 
...
alias rte_dma_vchan_setup = fn (Int16, UInt16, UnsafePointer[rte_dma_vchan_conf]) -> ffi.c_int
...
alias rte_dma_stats_get = fn (Int16, UInt16, UnsafePointer[rte_dma_stats]) -> ffi.c_int
alias rte_dma_stats_reset = fn (Int16, UInt16) -> ffi.c_int
...
alias rte_dma_dump = fn (Int16, UnsafePointer[FILE]) -> ffi.c_int
...
alias rte_dma_trace_stats_get = fn (Int16, UInt16, UnsafePointer[rte_dma_stats], ffi.c_int) -> NoneType
alias __rte_dma_trace_vchan_status = rte_trace_point_t
alias rte_dma_trace_vchan_status = fn (Int16, UInt16, UnsafePointer[rte_dma_vchan_status], ffi.c_int) -> NoneType
alias __rte_dma_trace_copy = rte_trace_point_t
alias rte_dma_trace_copy = fn (Int16, UInt16, rte_iova_t, rte_iova_t, ffi.c_int, ffi.c_ulong_long, ffi.c_int) -> NoneType
alias __rte_dma_trace_copy_sg = rte_trace_point_t
alias rte_dma_trace_copy_sg = fn (Int16, UInt16, UnsafePointer[rte_dma_sge], UnsafePointer[rte_dma_sge], UInt16, UInt16, ffi.c_ulong_long, ffi.c_int) -> NoneType
alias __rte_dma_trace_fill = rte_trace_point_t
alias rte_dma_trace_fill = fn (Int16, UInt16, ffi.c_ulong_long, rte_iova_t, ffi.c_int, ffi.c_ulong_long, ffi.c_int) -> NoneType
alias __rte_dma_trace_submit = rte_trace_point_t
alias rte_dma_trace_submit = fn (Int16, UInt16, ffi.c_int) -> NoneType
...
alias rte_dma_copy = fn (Int16, UInt16, rte_iova_t, rte_iova_t, ffi.c_int, ffi.c_ulong_long) -> ffi.c_int
alias rte_dma_copy_sg = fn (Int16, UInt16, UnsafePointer[rte_dma_sge], UnsafePointer[rte_dma_sge], UInt16, UInt16, ffi.c_ulong_long) -> ffi.c_int
alias rte_dma_fill = fn (Int16, UInt16, ffi.c_ulong_long, rte_iova_t, ffi.c_int, ffi.c_ulong_long) -> ffi.c_int
alias rte_dma_submit = fn (Int16, UInt16) -> ffi.c_int
