...
alias rte_stats_bitrate_create = fn (NoneType) -> UnsafePointer[rte_stats_bitrates]
alias rte_stats_bitrate_reg = fn (UnsafePointer[rte_stats_bitrates]) -> Int32
alias rte_stats_bitrate_calc = fn (UnsafePointer[rte_stats_bitrates], UInt16) -> Int32


alias rte_bitrate_alloca = ExternalFunction['alloca', alloca]
alias rte_bitrate_sched_setparam = ExternalFunction['sched_setparam', sched_setparam]
alias rte_bitrate_sched_getparam = ExternalFunction['sched_getparam', sched_getparam]
alias rte_bitrate_sched_setscheduler = ExternalFunction['sched_setscheduler', sched_setscheduler]
alias rte_bitrate_sched_getscheduler = ExternalFunction['sched_getscheduler', sched_getscheduler]
alias rte_bitrate_sched_yield = ExternalFunction['sched_yield', sched_yield]
alias rte_bitrate_sched_get_priority_max = ExternalFunction['sched_get_priority_max', sched_get_priority_max]
alias rte_bitrate_sched_get_priority_min = ExternalFunction['sched_get_priority_min', sched_get_priority_min]
alias rte_bitrate_sched_rr_get_interval = ExternalFunction['sched_rr_get_interval', sched_rr_get_interval]
alias rte_bitrate_rte_is_aligned = ExternalFunction['rte_is_aligned', rte_is_aligned]
alias rte_bitrate_rte_str_to_size = ExternalFunction['rte_str_to_size', rte_str_to_size]
alias rte_bitrate_rte_size_to_str = ExternalFunction['rte_size_to_str', rte_size_to_str]
alias rte_bitrate_rte_exit = ExternalFunction['rte_exit', rte_exit]
alias rte_bitrate_rte_stats_bitrate_free = ExternalFunction['rte_stats_bitrate_free', rte_stats_bitrate_free]
alias rte_bitrate_rte_stats_bitrate_create = ExternalFunction['rte_stats_bitrate_create', rte_stats_bitrate_create]
alias rte_bitrate_rte_stats_bitrate_reg = ExternalFunction['rte_stats_bitrate_reg', rte_stats_bitrate_reg]
alias rte_bitrate_rte_stats_bitrate_calc = ExternalFunction['rte_stats_bitrate_calc', rte_stats_bitrate_calc]
...
@fieldwise_init
struct rte_bitrate(Copyable, Movable):
    var lib: DLHandle
    
    var alloca: rte_bitrate_alloca.type
    var sched_setparam: rte_bitrate_sched_setparam.type
    var sched_getparam: rte_bitrate_sched_getparam.type
    var sched_setscheduler: rte_bitrate_sched_setscheduler.type
    var sched_getscheduler: rte_bitrate_sched_getscheduler.type
    var sched_yield: rte_bitrate_sched_yield.type
    var sched_get_priority_max: rte_bitrate_sched_get_priority_max.type
    var sched_get_priority_min: rte_bitrate_sched_get_priority_min.type
    var sched_rr_get_interval: rte_bitrate_sched_rr_get_interval.type
    var rte_is_aligned: rte_bitrate_rte_is_aligned.type
    var rte_str_to_size: rte_bitrate_rte_str_to_size.type
    var rte_size_to_str: rte_bitrate_rte_size_to_str.type
    var rte_exit: rte_bitrate_rte_exit.type
    var rte_stats_bitrate_free: rte_bitrate_rte_stats_bitrate_free.type
    var rte_stats_bitrate_create: rte_bitrate_rte_stats_bitrate_create.type
    var rte_stats_bitrate_reg: rte_bitrate_rte_stats_bitrate_reg.type
    var rte_stats_bitrate_calc: rte_bitrate_rte_stats_bitrate_calc.type

    fn __init__(out self):
        try:
            self.lib = DLHandle(_get_lib_path('librte_bitratestats.so'))
        except e:
            self.lib = abort[DLHandle](
                String("Failed to load rte_bitrate from", 'librte_bitratestats.so', ":\n", e)
            )

    
        self.alloca = rte_bitrate_alloca.load(self.lib)
        self.sched_setparam = rte_bitrate_sched_setparam.load(self.lib)
        self.sched_getparam = rte_bitrate_sched_getparam.load(self.lib)
        self.sched_setscheduler = rte_bitrate_sched_setscheduler.load(self.lib)
        self.sched_getscheduler = rte_bitrate_sched_getscheduler.load(self.lib)
        self.sched_yield = rte_bitrate_sched_yield.load(self.lib)
        self.sched_get_priority_max = rte_bitrate_sched_get_priority_max.load(self.lib)
        self.sched_get_priority_min = rte_bitrate_sched_get_priority_min.load(self.lib)
        self.sched_rr_get_interval = rte_bitrate_sched_rr_get_interval.load(self.lib)
        self.rte_is_aligned = rte_bitrate_rte_is_aligned.load(self.lib)
        self.rte_str_to_size = rte_bitrate_rte_str_to_size.load(self.lib)
        self.rte_size_to_str = rte_bitrate_rte_size_to_str.load(self.lib)
        self.rte_exit = rte_bitrate_rte_exit.load(self.lib)
        self.rte_stats_bitrate_free = rte_bitrate_rte_stats_bitrate_free.load(self.lib)
        self.rte_stats_bitrate_create = rte_bitrate_rte_stats_bitrate_create.load(self.lib)
        self.rte_stats_bitrate_reg = rte_bitrate_rte_stats_bitrate_reg.load(self.lib)
        self.rte_stats_bitrate_calc = rte_bitrate_rte_stats_bitrate_calc.load(self.lib)
