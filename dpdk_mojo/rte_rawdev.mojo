...
alias lcore_function_t = 	# # Node: PlaceHolder()
	# {"id":"0x39b86bb0","inner":[{"cc":"cdecl","id":"0x39b61000","inner":[{"id":"0x398deed0","kind":"BuiltinType","type":{"qualType":"int"}},{"id":"0x398dfb70","inner":[{"id":"0x398dee30","kind":"BuiltinType","type":{"qualType":"void"}}],"kind":"PointerType","type":{"qualType":"void *"}}],"kind":"FunctionProtoType","type":{"qualType":"int (void *)"}}],"kind":"ParenType","type":{"qualType":"int (void *)"}}
...
struct rte_rawdev_info(Copyable & Movable):
	...
	pass
alias rte_rawdev_info_get = fn (UInt16, UnsafePointer[rte_rawdev_info
rte_rawdev_info
], size_t) -> Int32
alias rte_rawdev_configure = fn (UInt16, UnsafePointer[rte_rawdev_info
rte_rawdev_info
], size_t) -> Int32
...
alias rte_rawdev_enqueue_buffers = fn (UInt16, UnsafePointer[UnsafePointer[rte_rawdev_buf
rte_rawdev_buf
]], UInt32, rte_rawdev_obj_t) -> Int32
alias rte_rawdev_dequeue_buffers = fn (UInt16, UnsafePointer[UnsafePointer[rte_rawdev_buf
rte_rawdev_buf
]], UInt32, rte_rawdev_obj_t) -> Int32
...
alias rte_rawdev_xstats_names_get = fn (UInt16, UnsafePointer[rte_rawdev_xstats_name
