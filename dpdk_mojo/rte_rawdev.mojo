...
alias rte_rawdev_socket_id = fn (UInt16) -> ffi.c_int
struct rte_rawdev_info(Copyable & Movable):

	pass
alias rte_rawdev_info_get = fn (UInt16, UnsafePointer[rte_rawdev_info], size_t) -> ffi.c_int
alias rte_rawdev_configure = fn (UInt16, UnsafePointer[rte_rawdev_info], size_t) -> ffi.c_int
alias rte_rawdev_queue_conf_get = fn (UInt16, UInt16, rte_rawdev_obj_t, size_t) -> ffi.c_int
alias rte_rawdev_queue_setup = fn (UInt16, UInt16, rte_rawdev_obj_t, size_t) -> ffi.c_int
alias rte_rawdev_queue_release = fn (UInt16, UInt16) -> ffi.c_int
alias rte_rawdev_queue_count = fn (UInt16) -> UInt16
alias rte_rawdev_start = fn (UInt16) -> ffi.c_int
alias rte_rawdev_stop = fn (UInt16) -> NoneType
alias rte_rawdev_close = fn (UInt16) -> ffi.c_int
alias rte_rawdev_reset = fn (UInt16) -> ffi.c_int
...
alias rte_rawdev_dump = fn (UInt16, UnsafePointer[FILE]) -> ffi.c_int
alias rte_rawdev_get_attr = fn (UInt16, UnsafePointer[Int8], UnsafePointer[ffi.c_ulong_long]) -> ffi.c_int
alias rte_rawdev_set_attr = fn (UInt16, UnsafePointer[Int8], ffi.c_long_long) -> ffi.c_int
alias rte_rawdev_enqueue_buffers = fn (UInt16, UnsafePointer[UnsafePointer[rte_rawdev_buf]], ffi.c_int, rte_rawdev_obj_t) -> ffi.c_int
alias rte_rawdev_dequeue_buffers = fn (UInt16, UnsafePointer[UnsafePointer[rte_rawdev_buf]], ffi.c_int, rte_rawdev_obj_t) -> ffi.c_int
struct rte_rawdev_xstats_name(Copyable & Movable):

	var name : InlineArray[Int8, 64]

alias rte_rawdev_xstats_names_get = fn (UInt16, UnsafePointer[rte_rawdev_xstats_name], ffi.c_int) -> ffi.c_int
alias rte_rawdev_xstats_get = fn (UInt16, UnsafePointer[ffi.c_int], UnsafePointer[ffi.c_ulong_long], ffi.c_int) -> ffi.c_int
alias rte_rawdev_xstats_by_name_get = fn (UInt16, UnsafePointer[Int8], UnsafePointer[ffi.c_int]) -> ffi.c_ulong_long
alias rte_rawdev_xstats_reset = fn (UInt16, UnsafePointer[ffi.c_int], ffi.c_int) -> ffi.c_int
alias rte_rawdev_firmware_status_get = fn (UInt16, rte_rawdev_obj_t) -> ffi.c_int
alias rte_rawdev_firmware_version_get = fn (UInt16, rte_rawdev_obj_t) -> ffi.c_int
alias rte_rawdev_firmware_load = fn (UInt16, rte_rawdev_obj_t) -> ffi.c_int
alias rte_rawdev_firmware_unload = fn (UInt16) -> ffi.c_int
alias rte_rawdev_selftest = fn (UInt16) -> ffi.c_int
