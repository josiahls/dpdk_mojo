...
alias rte_graph_destroy = fn (rte_graph_t) -> ffi.c_int
...
alias rte_graph_export = fn (UnsafePointer[Int8], UnsafePointer[FILE]) -> ffi.c_int
alias rte_graph_model_mcore_dispatch_core_bind = fn (rte_graph_t, ffi.c_int) -> ffi.c_int
...
alias rte_node_edge_update = fn (rte_node_t, rte_edge_t, UnsafePointer[UnsafePointer[Int8]], UInt16) -> rte_edge_t
...
alias rte_node_max_count = fn () -> rte_node_t
alias rte_node_dump = fn (UnsafePointer[FILE], rte_node_t) -> NoneType
alias rte_node_list_dump = fn (UnsafePointer[FILE]) -> NoneType
alias rte_node_is_invalid = fn (rte_node_t) -> ffi.c_int
alias rte_node_free = fn (rte_node_t) -> ffi.c_int
alias rte_edge_is_invalid = fn (rte_edge_t) -> ffi.c_int
alias rte_graph_is_invalid = fn (rte_graph_t) -> ffi.c_int
alias rte_graph_has_stats_feature = fn () -> ffi.c_int
