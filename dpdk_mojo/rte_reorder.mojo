...
alias rte_reorder_create = fn (UnsafePointer[Int8], ffi.c_int, ffi.c_int) -> UnsafePointer[rte_reorder_buffer]
alias rte_reorder_init = fn (UnsafePointer[rte_reorder_buffer], ffi.c_int, UnsafePointer[Int8], ffi.c_int) -> UnsafePointer[rte_reorder_buffer]
...
alias rte_reorder_insert = fn (UnsafePointer[rte_reorder_buffer], UnsafePointer[rte_mbuf]) -> ffi.c_int
alias rte_reorder_drain = fn (UnsafePointer[rte_reorder_buffer], UnsafePointer[UnsafePointer[rte_mbuf]], ffi.c_int) -> ffi.c_int
alias rte_reorder_drain_up_to_seqn = fn (UnsafePointer[rte_reorder_buffer], UnsafePointer[UnsafePointer[rte_mbuf]], ffi.c_int, rte_reorder_seqn_t) -> ffi.c_int
alias rte_reorder_min_seqn_set = fn (UnsafePointer[rte_reorder_buffer], rte_reorder_seqn_t) -> ffi.c_int
alias rte_reorder_memory_footprint_get = fn (ffi.c_int) -> ffi.c_int
