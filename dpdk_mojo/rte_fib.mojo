...
alias rte_fib_create = fn (UnsafePointer[Int8], ffi.c_int, UnsafePointer[rte_fib_conf]) -> UnsafePointer[rte_fib]
alias rte_fib_find_existing = fn (UnsafePointer[Int8]) -> UnsafePointer[rte_fib]
alias rte_fib_add = fn (UnsafePointer[rte_fib], ffi.c_int, UInt8, ffi.c_ulong_long) -> ffi.c_int
alias rte_fib_delete = fn (UnsafePointer[rte_fib], ffi.c_int, UInt8) -> ffi.c_int
alias rte_fib_lookup_bulk = fn (UnsafePointer[rte_fib], UnsafePointer[ffi.c_int], UnsafePointer[ffi.c_ulong_long], ffi.c_int) -> ffi.c_int
...
alias rte_fib_select_lookup = fn (UnsafePointer[rte_fib], rte_fib_lookup_type) -> ffi.c_int
alias rte_fib_rcu_qsbr_add = fn (UnsafePointer[rte_fib], UnsafePointer[rte_fib_rcu_config]) -> ffi.c_int
