...
alias rte_malloc = fn (UnsafePointer[Int8], size_t, ffi.c_int) -> OpaquePointer
alias rte_zmalloc = fn (UnsafePointer[Int8], size_t, ffi.c_int) -> OpaquePointer
alias rte_calloc = fn (UnsafePointer[Int8], size_t, size_t, ffi.c_int) -> OpaquePointer
alias rte_realloc = fn (OpaquePointer, size_t, ffi.c_int) -> OpaquePointer
alias rte_realloc_socket = fn (OpaquePointer, size_t, ffi.c_int, ffi.c_int) -> OpaquePointer
alias rte_malloc_socket = fn (UnsafePointer[Int8], size_t, ffi.c_int, ffi.c_int) -> OpaquePointer
alias rte_zmalloc_socket = fn (UnsafePointer[Int8], size_t, ffi.c_int, ffi.c_int) -> OpaquePointer
alias rte_calloc_socket = fn (UnsafePointer[Int8], size_t, size_t, ffi.c_int, ffi.c_int) -> OpaquePointer
alias rte_malloc_validate = fn (OpaquePointer, UnsafePointer[size_t]) -> ffi.c_int
alias rte_malloc_get_socket_stats = fn (ffi.c_int, UnsafePointer[rte_malloc_socket_stats]) -> ffi.c_int
alias rte_malloc_heap_memory_add = fn (UnsafePointer[Int8], OpaquePointer, size_t, UnsafePointer[rte_iova_t], ffi.c_int, size_t) -> ffi.c_int
alias rte_malloc_heap_memory_remove = fn (UnsafePointer[Int8], OpaquePointer, size_t) -> ffi.c_int
alias rte_malloc_heap_memory_attach = fn (UnsafePointer[Int8], OpaquePointer, size_t) -> ffi.c_int
alias rte_malloc_heap_memory_detach = fn (UnsafePointer[Int8], OpaquePointer, size_t) -> ffi.c_int
alias rte_malloc_heap_create = fn (UnsafePointer[Int8]) -> ffi.c_int
alias rte_malloc_heap_destroy = fn (UnsafePointer[Int8]) -> ffi.c_int
alias rte_malloc_heap_get_socket = fn (UnsafePointer[Int8]) -> ffi.c_int
alias rte_malloc_heap_socket_is_external = fn (ffi.c_int) -> ffi.c_int
...
struct rte_ip_frag_tbl(Copyable & Movable):
	pass
alias rte_ip_frag_table_create = fn (ffi.c_int, ffi.c_int, ffi.c_int, ffi.c_ulong_long, ffi.c_int) -> UnsafePointer[rte_ip_frag_tbl]
alias rte_ip_frag_table_destroy = fn (UnsafePointer[rte_ip_frag_tbl]) -> NoneType
alias rte_ipv6_fragment_packet = fn (UnsafePointer[rte_mbuf], UnsafePointer[UnsafePointer[rte_mbuf]], UInt16, UInt16, UnsafePointer[rte_mempool], UnsafePointer[rte_mempool]) -> ffi.c_int
...
alias rte_ipv4_fragment_packet = fn (UnsafePointer[rte_mbuf], UnsafePointer[UnsafePointer[rte_mbuf]], UInt16, UInt16, UnsafePointer[rte_mempool], UnsafePointer[rte_mempool]) -> ffi.c_int
alias rte_ipv4_fragment_copy_nonseg_packet = fn (UnsafePointer[rte_mbuf], UnsafePointer[UnsafePointer[rte_mbuf]], UInt16, UInt16, UnsafePointer[rte_mempool]) -> ffi.c_int
...
alias rte_ipv4_frag_pkt_is_fragmented = fn (UnsafePointer[rte_ipv4_hdr]) -> ffi.c_int
alias rte_ip_frag_free_death_row = fn (UnsafePointer[rte_ip_frag_death_row], ffi.c_int) -> NoneType
